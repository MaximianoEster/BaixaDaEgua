...
public class playerController : MonoBehaviour
{
    ...
    [HideInInspector] public bool travouBoss = false;
    [HideInInspector] public int stateBoss = 1;
    ...
    private void OnCollisionEnter2D(Collision2D other)
    {
        ...
        if (other.gameObject.CompareTag("tiromula") && !tomandoDano)
        {
            touchEnemy = true;
            countParada = 0;
            StartCoroutine(TomouDano());
        }
        if (other.gameObject.CompareTag("mulaBoss") && !tomandoDano)
        {
            touchEnemy = true;
            countParada = 0;
            StartCoroutine(TomouDano());
    ...
    void RecarregarFase()
    {
        ...
        Physics2D.IgnoreLayerCollision(8, 10, false);
        bombas = gameManager.bombas =  5;
        vida = gameManager.vida = 5;
